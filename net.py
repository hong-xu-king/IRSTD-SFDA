...
from model.SCTransNet.model_SCTransNet import *
    ...
    def __init__(self, model_name, mode):
        ...
        if model_name == 'SCTransNet':
            if mode == 'train':
                ...
                self.model = SCTransNet(mode='test')
            self.cal_loss = SC_BCEloss()
            ...
            self.model = RDIAN()
        elif model_name == 'NyhNet':
            self.model = iSmall()
        elif model_name == 'Ws_net':
            self.model = ESDNET()
