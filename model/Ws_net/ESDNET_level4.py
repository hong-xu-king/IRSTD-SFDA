...
class ESDNET(nn.Module):
    ...
    def forward(self, x):
        ...
        y_1, y_2, y_3,y_4 = self.encoder(x)
        out_1, out_2, out_3,out_4 = self.decoder(y_1, y_2, y_3,y_4)
        out_1 = F.interpolate(out_1,size=ori_shape,mode="bilinear")
        return out_1
...
class Decoder(nn.Module):
    def __init__(self, en_num, feature_num, inter_num, sam_number):
        ...
        self.preconv_4 = conv_relu(8 * en_num, feature_num, 3, padding=1)
        self.decoder_4 = Decoder_Level(feature_num, inter_num, sam_number)
        self.preconv_3 = conv_relu(4 * en_num+feature_num, feature_num, 3, padding=1)
    ...
    def forward(self, y_1, y_2, y_3,y_4):
        x_4 = y_4
        x_4 = self.preconv_4(x_4)
        out_4, feat_4 = self.decoder_4(x_4)

        x_3 = torch.cat([y_3, feat_4], dim=1)
...
class Encoder(nn.Module):
    def __init__(self, feature_num, inter_num, sam_number):
        ...
        self.conv_first = nn.Sequential(
            nn.Conv2d(4, feature_num, kernel_size=5, stride=1, padding=2, bias=True),
        ...
        self.encoder_4 = Encoder_Level(8 * feature_num, inter_num, level=4, sam_number=sam_number)
    def forward(self, x):
        ...
        out_feature_3,down_feature_3 = self.encoder_3(down_feature_2)
        out_feature_4 = self.encoder_4(down_feature_3)
        #16 48 128 128
        #16 96 64 64
        #16 192 32 32
        # 16 384 16 16
        return out_feature_1, out_feature_2, out_feature_3,out_feature_4
