...
class ESDNET(nn.Module):
    def __init__(self,
        ...
        self.LFF = LFF2(en_feature_num*4,en_feature_num*2,en_feature_num)
    def forward(self, x):
        ori_shape = x[0,0,:,:].shape
        y_1, y_2, y_3 = self.encoder(x)
        y_1,y_2_0,y_2_1,y_3 = self.LFF(y_3,y_2,y_1)
        out_1, out_2, out_3 = self.decoder(y_1, y_2_0,y_2_1, y_3)
...
class Decoder(nn.Module):
    def __init__(self, en_num, feature_num, inter_num, sam_number):
        ...
        self.preconv_2 = conv_relu(2 * en_num + 2 * en_num+feature_num, feature_num, 3, padding=1)
    ...
    def forward(self, y_1, y_2_0,y_2_1, y_3):
        x_3 = y_3
        x_3 = self.preconv_3(x_3)
        out_3, feat_3 = self.decoder_3(x_3)

        x_2 = torch.cat([y_2_0,y_2_1, feat_3], dim=1)
...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # out_feature_1 16 48 128 128
        # out_feature_2 16 96 64 64
        #out_feature_3  16 192 32 32
