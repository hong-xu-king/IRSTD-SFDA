...
from model.NyhNet.model import iSmall
from model.Ws_net.ESDNET_level4_vss import ESDNET
from model.VMunet.model import VMUNet
from model.SCTransNet.model_SCTransNet import SCTransNet